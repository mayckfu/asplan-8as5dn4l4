    ...
    extend: {
      ...
      colors: {
        ...
        asplan: {
          ...
          deep: 'hsl(var(--asplan-deep))',
          'blue-neutral': 'hsl(var(--asplan-blue-neutral))',
          bg: 'hsl(var(--asplan-bg))',
        },
        neutral: {
      ...
      animation: {
        ...
        'scale-up': 'scale-up 250ms ease-out',
        'scale-down': 'scale-down 250ms ease-out',
      },
    },
  },
